...
- STALE (>24h): Consider re-reading file and updating memory`,
      ...
      },
      {
        ...
        description: `Regenerate knowledge graph entities for a source file. Use when:
- A file has been modified and memories are stale
- You want to refresh function/class documentation
- After editing a file to update the knowledge graph
...
- Deletes entities for removed functions
...
Respects .gitignore and .dockerignore patterns.`,
        inputSchema: {
          ...
          required: ['file_path', 'project_root', 'group_id'],
        },
      },
    ],
  };
